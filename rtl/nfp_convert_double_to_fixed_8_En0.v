// -------------------------------------------------------------
// 
// File Name: hdlsrc\First_order_DiscreteTime_DeltaSigma_Modulator_516\nfp_convert_double_to_fixed_8_En0.v
...
// -------------------------------------------------------------
// 
// Module: nfp_convert_double_to_fixed_8_En0
// Source Path: First_order_DiscreteTime_DeltaSigma_Modulator_516/Digital_Decimation_Filter/nfp_convert_double_to_fixed_8_En0
// Hierarchy Level: 1
// Model version: 1.0
// 
...
module nfp_convert_double_to_fixed_8_En0
  ...
  output  signed [7:0] nfp_out;  // int8
  ...
  wire [60:0] Data_Type_Conversion1_out1_1;  // ufix61_En53
  reg [60:0] Data_Type_Conversion1_out1_2;  // ufix61_En53
  ...
  wire [60:0] Shift_Arithmetic1_out1;  // ufix61_En53
  wire Compare_To_Zero1_out1;  // ufix1
  wire Compare_To_Zero_out1_1;  // ufix1
  wire Logical_Operator_out1;  // ufix1
  wire [60:0] Bit_Set_out1;  // ufix61_En53
  wire [60:0] Switch2_out1_1;  // ufix61_En53
  reg [60:0] Delay4_out1_1;  // ufix61_En53
  ...
  wire [60:0] Shift_Arithmetic2_out1;  // ufix61_En53
  reg [60:0] Delay6_out1;  // ufix61_En53
  wire [60:0] Switch1_out1;  // ufix61_En53
  reg [60:0] Delay2_out1;  // ufix61_En53
  wire signed [61:0] Data_Type_Conversion3_out1;  // sfix62_En53
  wire signed [62:0] Unary_Minus_cast;  // sfix63_En53
  wire signed [62:0] Unary_Minus_cast_1;  // sfix63_En53
  wire signed [61:0] Unary_Minus_out1;  // sfix62_En53
  wire signed [61:0] Switch1_out1_1;  // sfix62_En53
  reg signed [61:0] Delay1_out1;  // sfix62_En53
  wire signed [7:0] Data_Type_Conversion2_out1;  // sfix8
  reg signed [7:0] Delay8_out1_1;  // sfix8
  ...
  assign Data_Type_Conversion1_out1_1 = {7'b0, {Data_Type_Conversion1_out1, 1'b0}};

  always @(posedge clk or posedge reset)
    begin : reduced_2_process
      if (reset == 1'b1) begin
        Data_Type_Conversion1_out1_2 <= 61'h0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Compare_To_Zero1_out1 = Shift_Arithmetic1_out1 == 61'h0000000000000000;

  assign Compare_To_Zero_out1_1 = Data_Type_Conversion1_out1_2 != 61'h0000000000000000;

  assign Logical_Operator_out1 = Compare_To_Zero1_out1 & Compare_To_Zero_out1_1;

  assign Bit_Set_out1 = Shift_Arithmetic1_out1 | 61'h0000000000000001;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay4_1_process
      if (reset == 1'b1) begin
        Delay4_out1_1 <= 61'h0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : Delay6_process
      if (reset == 1'b1) begin
        Delay6_out1 <= 61'h0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : Delay2_process
      if (reset == 1'b1) begin
        Delay2_out1 <= 61'h0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Unary_Minus_cast = {Data_Type_Conversion3_out1[61], Data_Type_Conversion3_out1};
  assign Unary_Minus_cast_1 =  - (Unary_Minus_cast);
  assign Unary_Minus_out1 = Unary_Minus_cast_1[61:0];
  ...
  always @(posedge clk or posedge reset)
    begin : Delay1_process
      if (reset == 1'b1) begin
        Delay1_out1 <= 62'sh0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Data_Type_Conversion2_out1 = Delay1_out1[60:53];

  always @(posedge clk or posedge reset)
    begin : Delay8_1_process
      if (reset == 1'b1) begin
        Delay8_out1_1 <= 8'sb00000000;
      end
      else begin
        if (enb) begin
...
endmodule  // nfp_convert_double_to_fixed_8_En0
