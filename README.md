...
**Rahul Ramteke** * Third Year Undergraduate Student, Indian Institute of Technology (IIT) Gandhinagar* *Specialization: Analog & Mixed-Signal IC Design / RTL Architecture / 3D ICs* *For professional inquiries, architecture discussions, or ASIC engineering roles, please reach out via GitHub or LinkedIn.*